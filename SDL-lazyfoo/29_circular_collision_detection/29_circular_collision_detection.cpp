...
void Dot::move( SDL_Rect& square, Circle& circle ) {
	...
	if( ( mPosY - mCollider.r < 0 ) || ( mPosY + mCollider.r > SCREEN_HEIGHT ) || checkCollision( mCollider, square ) || checkCollision( mCollider, circle ) ) {
		mPosY -= mVelY;
		shiftColliders(); }} // void Dot::move

void Dot::render() {
	gDotTexture.render( mPosX - mCollider.r, mPosY - mCollider.r ); } // void Dot::render

Circle& Dot::getCollider() {
	return mCollider; } // Circle& Dot::getCollider

void Dot::shiftColliders() {
	mCollider.x = mPosX;
	mCollider.y = mPosY; } // void Dot::shiftColliders
...
bool checkCollision( Circle& a, Circle& b ) {
    ...
    return false; } // bool checkCollision
...
double distanceSquared( int x1, int y1, int x2, int y2 ) {
	int deltaX = x2 - x1;
	int deltaY = y2 - y1;
	return deltaX*deltaX + deltaY*deltaY; } // double distanceSquared
